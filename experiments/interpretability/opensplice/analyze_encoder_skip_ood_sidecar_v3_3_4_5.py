#!/usr/bin/env python3
"""CPU-only structural audit for the prospective v3.3.4.5 OOD sidecar.
...
ANALYSIS_VERSION = 'v3.3.4.5-structural-analyzer-v1'
...
_ANALYSIS_DIR = _HERE / 'results/v3_3_4_5_development_ood_sidecar_analysis'
...
_TEST_PATH = _HERE / 'analyze_encoder_skip_ood_sidecar_v3_3_4_5_test.py'
...
def _create_append_only_directory(path: Path, *, root_role: str) -> None:
  ...
  _assert_cpu_only('v3.3.4.5 publication-directory helper import')
...
def _publish_new_bytes(
  ...
  import validate_encoder_skip_ood_sidecar_bootstrap_v3_3_4_5 as bootstrap  # pylint: disable=g-import-not-at-top
  _assert_cpu_only('v3.3.4.5 publication helper import')
