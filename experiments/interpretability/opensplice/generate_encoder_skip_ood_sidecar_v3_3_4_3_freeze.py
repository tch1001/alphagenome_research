#!/usr/bin/env python3
"""Generate the prospective v3.3.4.3 machine freeze from frozen predecessors."""
...
import run_encoder_skip_ood_sidecar_v3_3_4_3 as runner
...
def build_freeze() -> dict[str, object]:
  base = json.loads(
      bootstrap.V3_3_3_FREEZE_PATH.read_text(encoding='utf-8')
  )
  base.update({
      ...
      'preflight_script_version': 'opensplice-device-preflight-v3.3.4.3',
