...
readonly ANALYSIS_DIR="${OPEN_SPLICE}/results/v3_3_2_development_ood_sidecar_analysis_v3_3_2_1"
readonly ANALYZER="${OPEN_SPLICE}/analyze_encoder_skip_ood_sidecar_v3_3_2_1.py"
