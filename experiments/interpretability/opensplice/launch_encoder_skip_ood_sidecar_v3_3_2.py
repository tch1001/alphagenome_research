#!/usr/bin/env python3
"""Validate v3.3.2 frozen bytes, then load the sidecar in-process."""
...
ATTESTATION_MODULE = '_opensplice_v3_3_2_ood_sidecar_bootstrap_attestation'
...
def main() -> None:
  ...
  runpy.run_path(
      str(_HERE / 'run_encoder_skip_ood_sidecar_v3_3_2.py'),
      run_name='__main__',
  )
