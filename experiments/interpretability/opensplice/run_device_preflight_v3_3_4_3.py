#!/usr/bin/env python3
"""Sole append-only, JAX-only v3.3.4.3 external device preflight."""
...
_SUCCESS_PAYLOAD = b'opensplice-v3.3.4.3-renameat2-noreplace-probe-v1\n'
_COLLISION_PAYLOAD = b'opensplice-v3.3.4.3-collision-probe-v1\n'
